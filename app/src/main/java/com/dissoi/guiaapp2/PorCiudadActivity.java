...
public class PorCiudadActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener
{
    private static final String TAG = "PorCiudadActivity";

    private int mEspecialidadId;
    private String mEspecialidadNombre;
    private int mCiudadId;
    private String mCiudadNombre;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_por_ciudad);

        Toolbar toolbar = (Toolbar)findViewById(R.id.toolbarPorCiudad);
        setSupportActionBar(toolbar);

        NavigationView navigationView = (NavigationView)findViewById(R.id.navigationViewDrawer);
        navigationView.setNavigationItemSelectedListener(this);

        DrawerLayout drawer = (DrawerLayout)findViewById(R.id.drawerLayoutPorCiudad);
        ...
        mCiudadId = b.getInt("ciudad_id");
        mCiudadNombre = b.getString("ciudad_nombre");

        mListViewEmpresas = (ListView)findViewById(R.id.listViewPorCiudad);
        mListViewEmpresas.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                Intent intent = new Intent(PorCiudadActivity.this, EmpresaActivity.class);
                Bundle b = new Bundle();
        ...
        setTitle(mEspecialidadNombre + " en " + mCiudadNombre);
    }
    ...
    {
        super.onResume();
        getDataFromAPI(mEspecialidadId, mCiudadId);
    }

    void getDataFromAPI(int especialidadId, int ciudadId)
    {
        ...
        Call<List<Empresa>> call = service.getEmpresasByEspecialidadAndCiudad(especialidadId, ciudadId);
        ...
        call.enqueue(new Callback<List<Empresa>>()
        {
            ...
            public void onResponse(Response<List<Empresa>> response, Retrofit retrofit)
            {
                if (response.isSuccess())
                {
                    ...
                    EmpresaAdapter empresaListAdapter = new EmpresaAdapter(context, mEmpresas, false);
